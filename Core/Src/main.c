...
float temperature, error, destination, p_integral, prev_error, u, P, I, D, Integral, Derrivatie;
int32_t pressure;
int AdcValue;
char text[16], text_LCD[16];
...
float control(float, float, float, float, float, float);
void ADC_Read();
